...
class Game {
    ...
    attack(coords) {
        ...
        // TODO: THIS WON'T BE NECCESSARY ONCE PROMPTS ARE PROPERLY CONFIGURED
        // it won't be possible to take a turn until game is initialized
    ...
    advanceTurn() {
        ...
        // TODO: This is being controlled by the prompts now, so this can likely be deleted!
        if (!this.isHuman) {
            // DISABLE FOR NOW
