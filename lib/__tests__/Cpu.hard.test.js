...
// these tests helped to uncover some bugs!
...
const TEST_BOARD_3 = [
    ...
    [' B ','   ','   ','   ','   ','   ','CRU','   ','   ','   ','   ','   ','   '],
    [' C ','   ','   ','   ','   ','   ','CRU','   ','   ','   ','   ','   ','   '],
    [' D ','   ','   ',' 0 ','   ','   ','CRU','   ','   ','BTL','BTL','BTL','BTL'],
    [' E ','   ','   ','   ','   ','   ',' 0 ',' 0 ','   ','   ','   ',' 0 ',' 0 '],
    [' F ',' 0 ','   ','SUB','   ','   ','   ','   ','   ','   ','   ','   ','   '],
    [' G ','   ','   ','SUB','   ','   ','   ','   ','   ','   ','   ','   ','   '],
    [' H ',' 0 ','   ','SUB','   ','   ','   ','   ','   ','   ','   ','   ','   '],
    [' I ','   ',' 0 ','   ','   ','   ','   ','   ','   ','   ','   ','   ',' 0 '],
    [' J ','DST','DST','   ','   ','   ',' 0 ',' X ',' X ',' X ','CAR','CAR','   '],
    [' K ','   ','   ','   ','   ','   ','   ','   ','   ','   ','   ','   ','   '],
    [' L ','   ','   ','   ','   ','   ','   ',' 0 ','   ','   ','   ','   ','   ']
];
...
describe('AI Logic Tests (some edge cases)', () => {
    ...
    beforeEach(() => {
        ...
        cpu.hits = [];
        cpu.nextGuesses = [];
        cpu.opponentBoard = TEST_BOARD_3;
    });

    // uncovered a slight bug in the algorithm with this test!
    it('sinks carrier correctly, moving left then right, without ever going up or down', () => {
        cpu.hits.unshift('J7', 'J8', 'J9');

        var guess1 = cpu.generateGuess();
        expect(guess1).toBe('J10');
        cpu.hits.unshift('J10');
        cpu.opponentBoard[10][10] = ' X ';

        var guess2 = cpu.generateGuess();
        expect(guess2).toBe('J11');
    });
});
...
// 	var guess1 = cpu.generateGuess();
// 	console.log(guess1);
// 	let { row, col } = parseCoordinates(guess1);
// 	cpu.opponentBoard[row][col] = cpu.opponentBoard[row][col] === '   ' ? ' 0 ' : ' X ';
// 	if (cpu.opponentBoard[row][col] === ' X ') cpu.hits.unshift(guess1);
// }
