...
module.exports = {
    ...
    WELCOME: chalk.green('?') + '  Welcome to Battleship CLI! ' + chalk.dim('(Note: if your terminal does not support Emojis, please turn off Emoji support in settings) ') + chalk.cyan('Let\'s Play!\n')
}
